...
<body>
	...
	<div class="Lbody">
		...
		<div class="HjudulBerita">
			...
			<div class="col-md-4"><a href="<?php echo site_url('layanan/Kondisi')?>"><b>Kondisi Yang dilayani</b></a></div>
	...
	<div class="row putih1">
		<?php foreach ($fasilitas as $fasilitas): ?>
			<div class="col-md-3">
				<img src="<?php echo base_url('assets/upload/layanan/'.$fasilitas->gambar_layanan)?>" height="200px" >
			</div>
			<div class="col-md-8">
				<p><?php echo $fasilitas->isi_layanan; ?></p>
			</div>
			 <?php endforeach ?>
