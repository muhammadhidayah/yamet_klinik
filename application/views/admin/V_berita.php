					...
					<div class="table-responsive">
						<table class="table">
							<tr>
								...
								<th style="text-align: center;"><a href="<?php echo site_url('admin/berita/tambah_berita')?>">
									<button type="button" class="btn btn-success">+ Add News</button>
								</a></th>
							</tr>

							<tr>
								<th style="background-color: #8c8c8c;"><b>No.</b></th>
								<th style="background-color: #8c8c8c;" ><b>Judul</b></th>
								
								<th style="background-color: #8c8c8c; text-align: center;"  colspan="1"><b>Action</b></th>
								
								
							</tr>
							<?php $i = 0; foreach ($berita as $berita): ?>
								<tr>
									<td><b><?php $i++; echo $i; ?></b></td>
									<td><b><?php echo $berita->judul_post; ?></b></td>
									<td style="text-align: center;" >
										<a href="<?php echo site_url('admin/berita/editBerita/'.$berita->id_post); ?>"><button type="button" class="btn btn-info">Edit</button></a>
										<a href="<?php echo site_url('admin/berita/deleteBerita/'.$berita->id_post); ?>"><button type="button" class="btn btn-danger">Delete</button></a>
									</td>
