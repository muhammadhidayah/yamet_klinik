		...
		<div class="row putih2">
			<div class="col-md-12">
				...
				<div class="col-md-9 menutengah">
					<h5><b><i>Tambah Kelas</i></b></h5>
					
					<div class="table-responsive">
						<?php echo form_open_multipart('admin/Kelas/doTambahKelas'); ?>
					<table class="table">
						<tr><td>Isi</td>
							<td><textarea name="isi_kelasklinik" ></textarea></td>

						</tr>

						<tr><td>Kategori</td>
							<td>
								<select name="kategori_kelasklinik">
									<option>utama</option>
									<option>lain</option>
								</select>
							</td>
						...
						<tr><td>Gambar</td>
							<td><input type="file" name="gambar_kelasklinik" ></td>
						</tr>
