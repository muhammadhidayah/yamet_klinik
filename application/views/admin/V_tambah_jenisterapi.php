		...
		<div class="row putih2">
			<div class="col-md-12">
				...
				<div class="col-md-9 menutengah">
					...
					<div class="table-responsive">
						<?php echo form_open('admin/jenis_terapi/doTambah');?>
						<table class="table">
							...
							<tr>
								<td>
									<input type="text" name="jenis_terapi" class="form-control">
								</td>
							...
							<tr>
								<td><input type="text" name="biaya_terapi" class="form-control"></td>
