			...
			<div class="col-md-12">
				...
				<div class="table-responsive">
						<table class="table">
							...
							<th></th>
							<th></th>
							<th><a href="<?php echo site_url('admin/jenis_terapi/tambah')?>"><button type="button" class="btn btn-success">++ Add terapi</button></a></th>
							</tr>
							...
							<tr>
								...
								<?php foreach ($terapi as $terapi): ?>
									<tr>
										...
										<td><?php echo $terapi->biaya_terapi ?>
										</td>
										<td>
											<a href="<?php echo site_url('admin/jenis_terapi/edit/'.$terapi->id_jenisterapi) ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Sunting</a>
											<a href="<?php echo site_url('admin/jenis_terapi/delete/'.$terapi->id_jenisterapi) ?>" class="btn btn-sm btn-danger">Hapus</a>
										</td>
									</tr>		
								<?php endforeach ?>
