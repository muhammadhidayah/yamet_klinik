		...
		<div class="row putih2">
			<div class="col-md-12">
				...
				<div class="col-md-9 menutengah">
					...
					<div class="table-responsive">
						<?php echo form_open_multipart('admin/berita/doTambahBerita');  ?>
						<table class="table">
							<tr><td><b>Judul</b></td></tr>
							<tr><td><input type="text" name="judul_post" class="form-control" value="<?php echo set_value('judul_post') ?>" required></td></tr>

							<tr><td><b>Ringkasan</b></td></tr>
							<tr><td><input type="text" name="deskripsi_post" class="form-control" value="<?php echo set_value('deskripsi_post') ?>" required></td></tr>

							<tr><td><b>Image</b></td></tr>
							<tr><td><input type="file" name="gambar_post" required></td></tr>

							<tr><td><b>Content</b></td></tr>
							<tr><td><textarea name="isi_post"></textarea></td></tr>
							<tr><td>
