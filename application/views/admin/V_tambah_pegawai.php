...
<html>
<head>
	<title>Admin -tambah Pegawai</title>
		...
		<div class="row putih2">
			<div class="col-md-12">
				...
				<div class="col-md-5 menutengah">
					...
					<div class="table-responsive">
						<table class="table">
						<?php echo form_open('admin/pegawai/doTambahPegawai') ?>
						<tr><td><b>Nama</b></td><td><input type="text" name="nama_pegawai" class="form-control"></td></tr>

						<tr><td><b>Panggilan</b></td><td><input type="text" name="panggilan_pegawai" class="form-control"></td></tr>

						<tr><td><b>Tanggal Lahir</b></td><td><input type="date" name="tgllahir_pegawai" class="form-control"></td></tr>

						<tr><td><b>Agama</b></td><td><input type="text" name="agama_pegawai" class="form-control"></td></tr>
						...
						<tr><td><b>Pendidikan Akhir</b></td><td><input type="text" name="pendakhir_pegawai" class="form-control"></td></tr>

						<tr><td><b>Spesialis</b></td><td><input type="text" name="spesialis_pegawai" class="form-control"></td></tr>
