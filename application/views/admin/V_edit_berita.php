		...
		<div class="row putih1">
			<div class="col-md-12">
				...
				<div class="col-md-9">
					...
					<div class="table-responsive">
						<?php echo form_open_multipart('admin/berita/updateBerita');  ?>
						<table class="table">
							<tr><td><b>Judul</b></td></tr>
							<tr><td><input type="text" name="id_post" value="<?php echo $berita->id_post ?>" hidden><input type="text" name="judul_post" class="form-control" value="<?php echo $berita->judul_post ?>" required></td></tr>

							<tr><td><b>Ringkasan</b></td></tr>
							<tr><td><input type="text" name="deskripsi_post" class="form-control" value="<?php echo $berita->deskripsi_post ?>" required></td></tr>

							<tr><td><b>Image</b></td></tr>
							<tr><td><input type="file" name="gambar_post"></td></tr>

							<tr><td><b>Content</b></td></tr>
							<tr><td><textarea name="isi_post"><?php echo $berita->isi_post; ?></textarea></td></tr>
							<tr><td>
								<button type="submit" class="btn btn-primary">
								  <i class="icon-user icon-white"></i> Submit
								</button> <button type="submit" class="btn btn-warning">
								  <i class="icon-user icon-white"></i> Cancel
								</button>
								</td>
							</tr>
						</table>
