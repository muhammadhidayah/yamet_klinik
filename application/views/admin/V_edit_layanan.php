		...
		<div class="row putih2">
			<div class="col-md-12">
				...
				<div class="col-md-9 menutengah">
					...
					<div class="table-responsive">
						<?php echo form_open_multipart('admin/layanan/doUpdateLayanan'); ?>
					<table class="table">
						<tr><td>Isi</td>
							<td><input type="text" name="id_layanan" value="<?php echo $layanan->id_layanan ?>" hidden>
								<textarea name="isi_layanan" ><?php echo $layanan->isi_layanan; ?></textarea></td>

						</tr>
						<tr><td>Gamabar</td>
							<td><input type="file" name="gambar_layanan" ><img height="90px" src="<?php echo base_url('assets/upload/layanan/'.$layanan->gambar_layanan); ?>"></td>
						</tr>
