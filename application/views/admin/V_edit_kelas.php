		...
		<div class="row putih2">
			...
			<div class="col-md-3">
				...
				<div class="col-md-9 menutengah">
					<h5><b><i>Edit Kelas</i></b></h5>
					
					<div class="table-responsive">
						<?php echo form_open_multipart('admin/kelas/doUpdate'); ?>
					<table class="table">
						<tr><td>Isi</td>
							<td><input type="text" name="id_kelasklinik" value="<?php echo $kelas->id_kelasklinik ?>" hidden>
								<textarea name="isi_kelasklinik" ><?php echo $kelas->isi_kelasklinik; ?></textarea></td>

						</tr>
						<tr><td>Kategori</td>
							<td>
								<select name="kategori_kelaklinik">
									<option><?php echo $kelas->kategori_kelasklinik; ?></option>
									<option>utama</option>
									<option>lain</option>
								</select>
							</td>
						...
						<tr><td>Gamabar</td>
							<td><input type="file" name="gambar_kelasklinik" ><img height="90px" src="<?php echo base_url('assets/upload/kelas/'.$kelas->gambar_kelasklinik); ?>"></td>
						</tr>
