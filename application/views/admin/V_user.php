					...
					<div class="table-responsive">
						<table class="table">
							<tr>
								...
								<th></th>
								<th></th>
								<th><a href="<?php echo site_url('admin/user/tambahUser') ?>"><button type="button" class="btn btn-info">++ Add user</button></a></th>
							</tr>
							<tr>
								<th><b>Username</b></th>
								<th><b>Password</b></th>
							...
							<tr>
								<form action="<?php echo site_url('admin/user/updateUser') ?>" method="POST">
									<td><input value="<?php echo $user->username_pegawai ?>" type="text" name="username" readonly></td>
									...
									<td><a href="<?php echo site_url('admin/user/deletepegawailogin/'. $user->username_pegawai) ?>" class="btn btn-sm btn-danger">Hapus</a></td>
								</form>
							</tr>
							<?php } ?>
						</table>
