	...
	<div class="container-fluid">
		...
		<div class="row putih1">
			...
			<div class="col-md-4">
				...
				?>
				<form action="<?php echo site_url('auth/ClientLogin'); ?>" method="POST">
					<label for="inputEmail3" class="col-sm-2 col-form-label">Email</label>
				    <div class="form-group row">
				      
				      <div class="col-sm-10">
				        <input type="text" class="form-control" name="email_client" placeholder="Username">
				      </div>
				    </div>
				    ...
				    <div class="form-group row">
				      ...
				      <div class="col-sm-10">
				        <input type="password" class="form-control" name="password_client" placeholder="Password">
				      </div>
				    </div>
