		...
		<div class="row putih2">
			<div class="col-md-12">
				...
				<div class="col-md-9 menutengahter">
					...
					<div class="table-responsive">
						<?php echo form_open('terapis/perkembangan_client/updatePerkembanganclient'); ?>
						<table class="table">
						<tr>
							<?php echo $this->session->flashdata('msm'); ?>
							<td> Jenis Terapi</td>
							<td><input type="hidden" name="id_perkembanganclient" value="<?php echo $terapi->id_perkembanganclient ?>">
								<select name="id_jenisterapi">
								
									<option value="<?php echo $terapi->id_jenisterapi ?>">
										<?php echo $terapi->jenis_terapi; ?>
									</option>
						...
						<tr>
							...
							<td><input type="date" name="tanggal_perkembangan" value="<?php echo $terapi->tanggal_perkembangan; ?>" ></td>
						...
						<tr>
							...
							<td><select name="id_client">
									...
									<option value="<?php echo $terapi->id_client ?>">
										
								
								
								<?php echo $terapi->nama_client; ?>
						...
						<tr>
							<td>Keterangan</td>
							<td><textarea name="laporan_perkembanganclient">
							
								<?php echo $terapi->laporan_perkembanganclient; ?>
